            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="ListarLogin.php" target="centro">Listar Login</a>
                    </div>
                </li>-->
                <!--MENU ALUNO-->
                <li class="nav-item dropdown">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="" target="Centro"> Listar Núcleo de Atendimento</a>
                    </div>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="../View/PesquisarNucleoTreinamento.php" target="centro">Pesquisar Núcleo de Treinamento</a>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link text-dark text-uppercase" href="#">
                        <i class="fas fa-user-circle" data-toggle="tooltip" data-placement="left" title="Colaborador"></i>
                        <?php
                        echo $_SESSION["nome"];
                        ?>
                    </a>
